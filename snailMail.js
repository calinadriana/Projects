...
else if(numberOfAtCharacters>1)console.log(errorMessageTooManyAt);
else if(positionOfAt==0)console.log(errorMessageNoUsername);
else if(positionOfAt==lengthOfEmail - 1)console.log(errorMessageNoDomain);
else if(numberOfDotCharacters<1)console.log(errorMessageNoDot);
else if(positionOfFirstDotAfterTheAt<1)console.log(errorMessageNoDotInDomain);
else if(positionOfLastDot== - 1)console.log(errorMessageNoTld);
else if(positionOfAt==lengthOfEmail -2)console.log(errorMessageShortTld);
else if(positionOfFirstDot==0)console.log(errorMessageNoUsername);
else if(positionOfFirstDotAfterTheAt==positionOfAt+1)console.log(errorMessageNoServerName);
